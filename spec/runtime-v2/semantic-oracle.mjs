...
export const PORTABLE_PORTAL_SLOT_ACCOUNTING_STATUS = 'NO_TURRET_SLOT_COST';
...
export const NATURAL_PORTAL_MAP_MARKER = true;
export const NATURAL_PORTAL_DIRECTION_GUIDANCE = true;
export const NATURAL_PORTAL_DISTANCE_GUIDANCE = true;
export const NATURAL_PORTAL_MARKER_EXPIRY_STATUS = 'REMOVE_COMPLETELY';
export const NATURAL_PORTAL_MARKER_EXPIRES_WITH_WINDOW = true;
...
export const NARRATIVE_MILESTONES_PERSIST_IMMEDIATELY = true;
export const NOMA_PERMANENT_DEATH_ALLOWED = false;
export const ALLY_DOWNED_BLEEDOUT_TIMER = false;
export const ALLY_DOWNED_DEATH_TRIGGER = 'ADDITIONAL_HOSTILE_DAMAGE';
export const ALLY_PORTAL_DISCOVERY_RULE_STATUS = 'SEMANTIC_QUESTION';
export const WORLD2_GEM_SOURCE = 'ALLY_INTEL_TO_HIGH_THREAT_CARRIER_ELITE_ENCOUNTER';
export const BEACON_DEPLOY_AUTHORITY = 'PLAYER_ASTRONAUT_MANUAL';
export const BEACON_ALWAYS_VISIBLE_ON_MAP_WHILE_DEPLOYED = true;
export const BEACON_DETECTS = Object.freeze(['ENEMIES','HORDES','NATURAL_PORTALS']);
export const BEACON_GENERIC_POI_DETECTION = false;
export const BEACON_PARKING_ANCHOR_FOR = Object.freeze(['PLAYER_SHIP','BIKE']);
export const BEACON_WORLD_TRANSITION_RECOVERY = 'DIRECT_TO_INVENTORY_NO_RING_TRAVEL';
export const BEACON_MULTIPLE_DEPLOYMENT_ALLOWED = true;
export const BEACON_REMOTE_RECALL_DURING_WORLD = false;
export const BEACON_PASSIVE_VEHICLE_PROTECTION = false;
export const BEACON_PROTECTION_SOURCE = 'MOUNTED_TURRET_ONLY';
export const BEACON_SENSOR_MARKER_PERSISTENCE = 'LIVE_ONLY_REMOVE_WHEN_NOT_DETECTED';
export const WORLD1_GEM_SOURCE = 'NOMA_DISCOVERY_PROTECTED_GUARDIAN_ENCOUNTER';
